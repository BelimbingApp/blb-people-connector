...
**Status:** 2026-09-05 — integration-only ownership under [People plan 0001](https://github.com/BelimbingApp/blb-people/blob/main/docs/plans/0001-people-architecture-and-provider-boundaries.md); Skill and Training relocation is pending.
...
Skills, Training and Progression business records belong to the selected People installation. The current `Skill/` and `Training/` directories are relocation sources for [People #113 (R2)](https://github.com/BelimbingApp/blb-people/issues/113) and [People #114 (R3)](https://github.com/BelimbingApp/blb-people/issues/114), pending source removal in [connector #121 (R4)](https://github.com/BelimbingApp/blb-people-connector/issues/121). They do not establish a second business authority. Provider replacement and outages must preserve People business history without switching to a connector fallback writer.
